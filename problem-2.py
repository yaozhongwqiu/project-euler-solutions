...
# 36.2 µs ± 8.12 µs per loop (mean ± std. dev. of 7 runs, 10000 loops each)
# 3.46 µs ± 346 ns per loop (mean ± std. dev. of 7 runs, 100000 loops each)
# 8.16 µs ± 1.07 µs per loop (mean ± std. dev. of 7 runs, 100000 loops each)
